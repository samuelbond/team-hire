...
<div class="main-block">
    ...
    <div class="page-heading-two">
        <div class="container">
            <h2><a href="cmspage">Go Back to Cms Pages</a> <span></span></h2>
                            ...
                            <form method="post" action="editpage" enctype="multipart/form-data">
                                <div class="rptable table-responsive">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="page_title" class="form-control" id="exampleInputName" value="<?php echo $page[0]['title']; ?>" >
                                    </div>

                                    <div class="rptable table-responsive">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Page Content</label>
                                            <textarea class="form-control" name="page_content" id="content"><?php echo $page[0]['content']; ?></textarea>
                                        </div>
